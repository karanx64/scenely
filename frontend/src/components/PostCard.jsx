...
//               onClick={prev}
//               tabIndex={-1}
//               className="btn btn-sm btn-circle absolute left-2 top-1/2 -translate-y-1/2 bg-black/50 text-white z-20"
//             >
//               <ChevronLeft size={20} />
//             </button>
//             <button
//               onClick={next}
//               tabIndex={-1}
//               className="btn btn-sm btn-circle absolute right-2 top-1/2 -translate-y-1/2 bg-black/50 text-white z-20"
//             >
